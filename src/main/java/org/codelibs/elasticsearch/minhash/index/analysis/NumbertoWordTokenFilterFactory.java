...
public class NumbertoWordTokenFilterFactory extends AbstractTokenFilterFactory {

    private final int hashBit;

    private final HashFunction[] hashFunctions;

    public NumbertoWordTokenFilterFactory(final IndexSettings indexSettings, final Environment environment, final String name, final Settings settings) {
