...
public  class ShamsiDate {  
   ...
   * Contractor
   */
  public ShamsiDate(Long timeInMilliSecond) {
  ...
  public String toString() {
    return ShamsiDateFormat.format(this, null);
  }
  ...
  public ShamsiDate setLocal(Locale locale) {
    this.locale = locale;
    return this;
  }
  ...
  public ShamsiDate setDialect(Dialect dialect) {
   ...
   */
  public ShamsiDate setShYear(int shYear) throws IllegalArgumentException {
    if (shYear < 1) {
      throw new IllegalArgumentException("ShamsiDate Error: ##=> Year must be greater than 0");
    }
    this.shYear = shYear;
   ...
   */
  public ShamsiDate setShMonth(int shMonth) throws IllegalArgumentException {
    if (shMonth < 1 || shMonth > 12) {
      throw new IllegalArgumentException("ShamsiDate Error: ##=> Month must be between 1 and 12");
    }
   ...
   * @return ShamsiDate object
   * @throws IllegalArgumentException Return Exception if Day is less than 1 or greater than 29~31
   * (Depend on Month Length)
   */
  public ShamsiDate setShDay(int shDay) throws IllegalArgumentException {
    if (shDay < 1 || shDay > 31) {
      throw new IllegalArgumentException("ShamsiDate Error: ##=> Day must be between 1 and 29~31");
    }
    if (shDay > this.getMonthLength()) {
      throw new IllegalArgumentException(
          "ShamsiDate Error: ##=> Day in the " + this.getMonthName() + " must be between 1 and "
              + this.getMonthLength());
    }
    this.shDay = shDay;
    this.changeTime(true);
   ...
   * @throws IllegalArgumentException Return Exception if Year is less than 1
   */
  public ShamsiDate setGrgYear(int grgYear) throws IllegalArgumentException {
    if (grgYear < 1) {
      throw new IllegalArgumentException("ShamsiDate Error: ##=> Year must be greater than 0");
    }
   ...
   * @throws IllegalArgumentException Return Exception if Month is less than 1 or greater than 12
   */
  public ShamsiDate setGrgMonth(int grgMonth) throws IllegalArgumentException {
   ...
   * (Depend on Month Length)
   */
  public ShamsiDate setGrgDay(int grgDay) throws IllegalArgumentException {
    if (grgDay < 1 || grgDay > 31) {
      throw new IllegalArgumentException("ShamsiDate Error: ##=> Day must be between 1 and 28~31");
    }
    if (grgDay > this.getGrgMonthLength()) {
      throw new IllegalArgumentException(
          "ShamsiDate Error: ##=> Day in the " + this.getGrgMonthName() + " must be between 1 and "
   ...
   * and 23
   */
  public ShamsiDate setHour(int hour) throws IllegalArgumentException {
    if (hour < 0 || hour > 23) {
      throw new IllegalArgumentException("ShamsiDate Error: ##=> Hour must be between 0 and 23");
    }
    this.hour = hour;
    changeTime(false);
    return this;
   ...
   * and 59
   */
  public ShamsiDate setMinute(int minute) throws IllegalArgumentException {
    if (minute < 0 || minute > 59) {
      throw new IllegalArgumentException("ShamsiDate Error: ##=> Minute must be between 0 and 59");
    }
    this.minute = minute;
    changeTime(false);
    return this;
   ...
   * and 59
   */
  public ShamsiDate setSecond(int second) throws IllegalArgumentException {
    if (second < 0 || second > 59) {
      throw new IllegalArgumentException("ShamsiDate Error: ##=> Second must be between 0 and 59");
    }
    this.second = second;
    changeTime(false);
    return this;
   ...
   * @return ShamsiDate
   */
  public ShamsiDate initGrgDate(int year, int month, int day) throws IllegalArgumentException {
   ...
   * @return ShamsiDate
   */
  public ShamsiDate initGrgDate(int year, int month, int day, int hour, int minute, int second)
    ...
    if (day > this.getGrgMonthLength(year, month)) {
      throw new IllegalArgumentException(
          "ShamsiDate Error: ##=> Day in the " + this.getGrgMonthName(month)
   ...
   * @return ShamsiDate
   */
  public ShamsiDate initJalaliDate(int year, int month, int day) throws IllegalArgumentException {
   ...
   * @return ShamsiDate
   */
  public ShamsiDate initJalaliDate(int year, int month, int day, int hour, int minute,
    ...
    if (day > this.getMonthLength(year, month)) {
      throw new IllegalArgumentException(
          "ShamsiDate Error: ##=> Day in the " + this.monthName(month) + " must be between 1 and "
  ...
  public static boolean isJalaliLeap(int year) {
    return (new ShamsiDate().isLeap(year));
  }
  ...
  public static boolean isGrgLeap(int year) {
    return (new ShamsiDate().grgIsLeap(year));
  }
  ...
  /**
   * Get day of week from ShamsiDate object
   *
   * @param date ShamsiDate
   * @return int
   */
  public int dayOfWeek(ShamsiDate date) {
  ...
  public ArrayList<ShamsiDate> getWeek(ShamsiDate date) {
    ArrayList<ShamsiDate> currentWeek = new ArrayList<>();
    for (int i = 0; i < date.dayOfWeek(); i++) {
      ShamsiDate dateTmp = new ShamsiDate(date.timeInMilliSecond);
  ...
  public ShamsiDate[] getWeek() {
    return getWeek(this).toArray(new ShamsiDate[0]);
  }
  ...
  /**
   * Get current month name in Shamsi
   */
   ...
   * Get Day Name
   */
  public String dayName(ShamsiDate date) {
   ...
   * Get Finglish Day Name
   */
  public String dayFinglishName(ShamsiDate date) {
   ...
   * Get English Day Name
   */
  public String dayEnglishName(ShamsiDate date) {
   ...
   * @return this
   */
  public ShamsiDate subDate(long SubYear, long SubMonth, long SubDay, long SubHour, long SubMinute,
      long SubSecond) {
    Calendar cal = Calendar.getInstance();
    //add day to cal
   ...
   * @return this
   */
  public ShamsiDate subDate(long SubYear, long SubMonth, long SubDay) {
   ...
   * @return this
   */
  public ShamsiDate subYears(int years) {
   ...
   * @return this
   */
  public ShamsiDate subMonths(int months) {
   ...
   * @return this
   */
  public ShamsiDate subDays(int days) {
   ...
   * @return this
   */
  public ShamsiDate subHours(int hours) {
   ...
   * @return this
   */
  public ShamsiDate subMinutes(int minutes) {
   ...
   * @return this
   */
  public ShamsiDate subSeconds(int seconds) {
   ...
   * @return this
   */
  public ShamsiDate subSecond() {
    return this.subSeconds(1);
  }

  public ShamsiDate subWeeks(int weeks) {
    return this.subDays(7*weeks);
  }

  public ShamsiDate subWeek() {
   ...
   * @return new date
   */
  public ShamsiDate addDate(long AddYear, long AddMonth, long AddDay, long AddHour, long AddMinute,
   ...
   */
  public ShamsiDate addDate(long year, long month, long day) {
    return this.addDate(year, month, day, 0, 0, 0);
  }

  public ShamsiDate addYear() {
    return this.addYears(1);
  }
  public ShamsiDate addYears(int year) {
    return this.addDate(year, 0, 0);
  }

  public ShamsiDate addMonth() {
    return this.addMonths(1);
  }
  public ShamsiDate addMonths(int month) {
    return this.addDate(0, month, 0);
  }

  public ShamsiDate addWeek() {
    return this.addWeeks(1);
  }
  public ShamsiDate addWeeks(int week) {
    return this.addDays(7*week);
  }

  public ShamsiDate addDay() {
    return this.addDays(1);
  }

  public ShamsiDate addDays(int day) {
    return this.addDate(0, 0, day);
  }

  public ShamsiDate addHour() {
    return this.addHours(1);
  }

  public ShamsiDate addHours(int hour) {
    return this.addDate(0, 0, 0, hour, 0, 0);
  }

  public ShamsiDate addMinute() {
    return this.addMinutes(1);
  }

  public ShamsiDate addMinutes(int minute) {
    return this.addDate(0, 0, 0, 0, minute, 0);
  }

  public ShamsiDate addSecond() {
    return this.addSeconds(1);
  }

  public ShamsiDate addSeconds(int second) {
   ...
   * Compare 2 date
   *
   * @param dateInput ShamsiDate type
   */
  public Boolean after(ShamsiDate dateInput) {
   ...
   */
  public Boolean before(ShamsiDate dateInput) {
   ...
   * Check date equals
   */
  public Boolean equals(ShamsiDate dateInput) {
   ...
   */
  public int compareTo(ShamsiDate anotherDate) {
    return (this.timeInMilliSecond.compareTo(anotherDate.getTime()));
  }

  /**
   * Check if ShamsiDate is today or not
   *
   * @return boolean
   */
  ...
  /**
   * Check if given ShamsiDate is today or not
   *
   * @param date Date to check is today or not
   * @return boolean
   */
  public boolean isToday(ShamsiDate date) {
  ...
  public long getDayUntilToday() {
    return this.getDayUntilToday(new ShamsiDate());
  }
   ...
   */
  public long getDayUntilToday(ShamsiDate date) {
  ...
  public long[] untilToday() {
    return this.untilToday(new ShamsiDate());
  }
   ...
   * @param date Date 1
   */
  public long[] untilToday(ShamsiDate date) {
  ...
  /**
   * convert ShamsiDate class to date
   */
  public Date toDate() {
   ...
   * Return today
   */
  public static ShamsiDate today() {
    ShamsiDate ShamsiDate = new ShamsiDate();
    ShamsiDate.setHour(0).setMinute(0).setSecond(0);
    return ShamsiDate;
  }
   ...
   * Get tomorrow
   */
  public static ShamsiDate tomorrow() {
    ShamsiDate ShamsiDate = new ShamsiDate();
    ShamsiDate.addDay();
    ShamsiDate.setHour(0).setMinute(0).setSecond(0);
    return ShamsiDate;
   ...
   * Get start of day
   */
  public ShamsiDate startOfDay(ShamsiDate ShamsiDate) {
    ShamsiDate.setHour(0).setMinute(0).setSecond(0);
    return ShamsiDate;
  }
   ...
   * Get end of day
   */
  public ShamsiDate endOfDay(ShamsiDate ShamsiDate) {
    ShamsiDate.setHour(23).setMinute(59).setSecond(59);
    return ShamsiDate;
  }
   ...
   * Check midnight
   */
  public Boolean isMidNight(ShamsiDate ShamsiDate) {
    return ShamsiDate.isMidNight();
  }
   ...
   * Get short name time of the day
   */
  public String getShortTimeOfTheDay(ShamsiDate ShamsiDate) {
    return (ShamsiDate.isMidNight()) ? AM_SHORT_NAME : PM_SHORT_NAME;
  }
   ...
   * Get time of the day
   */
  public String getTimeOfTheDay(ShamsiDate ShamsiDate) {
    return (ShamsiDate.isMidNight()) ? AM_NAME : PM_NAME;
  }
   ...
   * Get number of days in month
   *
   * @param ShamsiDate ShamsiDate object
   * @return number of days in month
   */
  public int getMonthLength(ShamsiDate ShamsiDate) {
    return this.getMonthLength(ShamsiDate.getShYear(), ShamsiDate.getShMonth());
  }
  ...
  public String getMonthName(ShamsiDate pDate, Dialect dialect) {
  ...
  public String getMonthName(ShamsiDate pDate) {
  ...
  private void updateTimeStamp() {
    try {
      this.timeInMilliSecond = Objects
          ...
          .getTime();//reported in #https://github.com/samanzamani/ShamsiDate/issues/54
